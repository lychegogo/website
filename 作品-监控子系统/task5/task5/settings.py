...
SECRET_KEY = 'l^&-apbpkw*wf&!m29gyks#jji*s=ex+s3r*wca(mh=%zp&cpn'
...
TEMPLATE_DIRS = (
    ...
    os.path.join(PROJECT_BASE_DIR, 'task5'),
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'task5','static')],
        'APP_DIRS': False,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = (
        ...
        BASE_DIR,
        # os.path.join(BASE_DIR, 'task5.static'),
    )